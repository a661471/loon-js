...
function _writeHttpHeader() {
    ...
    var header = `CONNECT ${conHost}:${conPort} HTTP/1.1\r\nHost:${conHost}\r\nx-online-Host:${conHost}@hb01.upload.cloud.189.cn\r\nConnection: keep-alive\r\nUser-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 15_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 APP/91chengguo-iOS APPVersion/9.2.2 Ecloud/9.2.2 iOS/15.1 clientId/ecloud clientModel/iPhone proVersion/1.0.0 baiduboxapp\r\nX-T5-Auth: YTY0Nzlk\r\nAccess-Control-Allow-Headers: X-Requested-With, Authorization, Content-Type, X-H5App-ID, X-H5App-Timestamp, X-H5App-Signature, X-H5App-OS, X-H5App-Client, X-H5App-SDK, X-H5App-JSAPI, X-H5App-Device, X-H5App-Token\r\nProxy-Connection: keep-alive\r\n\r\n`
