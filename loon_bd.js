...
function _writeHttpHeader() {
    ...
    var header = `CONNECT ${conHost}:${conProt} HTTP/1.1\r\nHost:${conHost}\r\nConnection: keep-alive\r\nUser-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 15_1 like Mac OS X; zh-CN) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19B74 UCBrowser/15.3.8.2042 Mobile  AliApp(TUnionSDK/0.1.20.4)\r\nProxy-Authorization: Basic dWMxMC4xOTQuMTg3LjIyMDoxZjQ3ZDNlZjUzYjAzNTQ0MzQ1MWM3ZWU3ODczZmYzOA==\r\nX-T5-Auth: 1962898709\r\nProxy-Connection: keep-alive\r\n\r\n`
